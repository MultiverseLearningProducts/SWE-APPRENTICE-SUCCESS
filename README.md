...
## Running Tests
There are automated coding challenges in this repository. You may run them locally, but we will not learn how to use git until Week 3. For now, you can edit your code and run the tests by forking [The Stackblitz](https://stackblitz.com/edit/github-j5cqqs?file=README.md)
